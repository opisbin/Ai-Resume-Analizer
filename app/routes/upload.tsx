...
const upload = () => {
    ...
    const handleAnalize = async ({companyName, jobTitle, jobDescription, file}: {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        setIsProcessing(true);

        setStatusText("Uploading and analyzing your resume...");
        // if(!file) {
        //     setStatusText("No file selected. Please upload a PDF file.");
        //     return;
        // }
